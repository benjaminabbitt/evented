...
import (
	"github.com/benjaminabbitt/evented/applications/event/saga/grpc/saga/configuration"
	"github.com/benjaminabbitt/evented/applications/event/saga/grpc/saga/saga"
...
Parses the result of the sync placeholder-saga, updating last processed event in storage.
Sends the placeholder-saga generated events to the other command handler
Returns the result of the sync placeholder-saga.
*/
func main() {
	log := support.Log()
	defer log.Sync()
