...
import (
	"context"
	"github.com/benjaminabbitt/evented/applications/event/projector/grpc/projector/configuration"
	"github.com/benjaminabbitt/evented/applications/event/projector/grpc/projector/projector"
...
Parses the result of the sync placeholder-projector, updating last processed event in storage.
...
func main() {
	...
	req := &grpc_health_v1.HealthCheckRequest{Service: "evented-sample-placeholder-projector"}
