...
generate-mocks: generate-proto build-gomock
	...
	${mockgen-common} -source ${WORKSPACE}/proto/gen/github.com/benjaminabbitt/evented/proto/evented/evented.pb.go -destination ${WORKSPACE}/proto/gen/github.com/benjaminabbitt/evented/proto/evented/mocks/evented.mock.pb.go
	${mockgen-common} -source ${WORKSPACE}/proto/gen/github.com/benjaminabbitt/evented/proto/evented/evented_grpc.pb.go -destination ${WORKSPACE}/proto/gen/github.com/benjaminabbitt/evented/proto/evented/mocks/evented_grpc.mock.pb.go
