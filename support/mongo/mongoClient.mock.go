...
func (o *MockMongoClient) StartSession(opts ...*options.SessionOptions) (mongo.Session, error) {
	args := o.Called(opts)
	return args.Get(0).(mongo.Session), args.Error(0)
}
...
func (o *MockMongoClient) Watch(ctx context.Context, pipeline interface{}, opts ...*options.ChangeStreamOptions) (*mongo.ChangeStream, error) {
